...
impl GraphicsPipeline {
    pub(crate) fn create(
        ...
        let viewports = [vk::Viewport {
            x: 0.0,
            y: 0.0,
            width: surface_data.surface_resolution.width as f32,
            height: surface_data.surface_resolution.height as f32,
            min_depth: 0.0,
            max_depth: 1.0,
        }];
        let scissors = [surface_data.surface_resolution.into()];
